...
plt.plot(episode, acc_worst_good_n, color=(0/255, 255/255, 255/255))
...
plt.plot(episode, acc_avg_good_c, color=(0/255, 255/255, 255/255))
plt.title("Good + intermediate group average accuracy")
plt.ylabel("Accuracy")
plt.xlabel("Episode")
plt.grid(True)
plt.savefig(f.model_path[0:-10]+'acc_avg_good_c.jpg')
plt.show()
plt.close()

plt.plot(episode, acc_worst_good_c, color=(0/255, 255/255, 255/255))
plt.title("Good + intermediate group worst accuracy")
plt.ylabel("Accuracy")
plt.xlabel("Episode")
plt.grid(True)
plt.savefig(f.model_path[0:-10]+'acc_worst_good_c.jpg')
plt.show()
plt.close()